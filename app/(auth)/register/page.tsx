...
export default function RegisterPage() {
  ...
  return (
    // ── Page background ────────────────────────────────────────────────────
    <div className="relative min-h-screen w-full flex items-center justify-center px-4 py-10 overflow-hidden bg-[hsl(230_35%_6%)]">

      {/* Ambient blobs */}
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-[500px] h-[500px] rounded-full bg-primary/10 blur-[120px]" />
        <div className="absolute -bottom-40 -left-40 w-[500px] h-[500px] rounded-full bg-secondary/8 blur-[120px]" />
        ...
        <div className="relative rounded-3xl border border-white/[0.08] bg-[hsl(230_30%_9%/0.85)] backdrop-blur-2xl p-8 shadow-[0_32px_80px_hsl(0_0%_0%/0.5)]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="name" className="text-muted-foreground text-[10px] uppercase tracking-widest">
                Full Name
              </Label>
              <Input
                id="name"
            ...
            {/* Referral Code */}
            <div className="space-y-2">
              <Label htmlFor="referralCode" className="text-muted-foreground text-[10px] uppercase tracking-widest">
                Referral Code{" "}
                <span className="normal-case text-muted-foreground/40">(optional)</span>
              </Label>
              <Input
                id="referralCode"
                name="referralCode"
                ...
                onChange={handleChange}
                className="bg-white/[0.04] border-white/[0.08] focus:border-primary/50 focus:bg-white/[0.06] h-11 uppercase transition-colors placeholder:text-muted-foreground/40"
              />
            </div>
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-11 mt-1 bg-primary text-primary-foreground font-semibold hover:bg-primary/90 transition-all hover:shadow-[0_0_24px_hsl(45_95%_58%/0.4)] disabled:opacity-60"
            >
              {loading ? (
